...
{
    [Control("ToolTip")]
    public class UIToolTip : UIBaseControl
    {
        private string name = "";
        ...
        public UIToolTip(int ThreadIndex, string ControlName, string Screen, string Action, string Type, string SearchType, string SearchParameter)
